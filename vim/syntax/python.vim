...
" URL:       http://www.hlabs.spb.ru/vim/python.vim
" Last Change:   $Date: 2006-09-26 15:46:55 +0400 (Ð’Ñ‚Ñ€, 26 Ð¡ÐµÐ½ 2006) $
" Filenames: *.py
" Version:   2.5.5
" $Rev: 477 $
"
...
if exists("python_highlight_builtins") && python_highlight_builtins != 0
  ...
  syn keyword pythonBuiltinFunc  True False Ellipsis None NotImplemented

  syn keyword pythonBuiltinFunc  __import__ abs all any apply
  syn keyword pythonBuiltinFunc  basestring bool buffer callable
  syn keyword pythonBuiltinFunc  chr classmethod cmp coerce compile complex
  syn keyword pythonBuiltinFunc  delattr dict dir divmod enumerate eval
  syn keyword pythonBuiltinFunc  execfile exit file filter float frozenset getattr
  syn keyword pythonBuiltinfunc globals hasattr hash help hex id 
  syn keyword pythonBuiltinFunc  input int intern isinstance
  syn keyword pythonBuiltinFunc  issubclass iter len list locals long map max
  syn keyword pythonBuiltinFunc  min object oct open ord pow property quit range
  syn keyword pythonBuiltinFunc  raw_input reduce reload repr
  syn keyword pythonBuiltinFunc reversed round set setattr
  syn keyword pythonBuiltinFunc  slice sorted staticmethod str sum super trunc tuple
  syn keyword pythonBuiltinFunc  type unichr unicode vars xrange zip self
endif
